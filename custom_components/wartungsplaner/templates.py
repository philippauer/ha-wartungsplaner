...
TASK_TEMPLATES: list[dict] = [
    ...
    # --- Pool ---
    {
        "id": "pool_wasserqualitaet",
        "name": "Poolwasser testen",
        "description": "pH-Wert, Chlorgehalt und Alkalinität des Poolwassers messen und bei Bedarf anpassen",
        "category": TaskCategory.EXTERIOR,
        "priority": TaskPriority.HIGH,
        "interval_value": 1,
    ...
    {
        "id": "pool_filter",
        "name": "Poolfilter reinigen",
        "description": "Poolfilter (Sand/Kartuschen) rückspülen oder reinigen, Skimmerkorb leeren",
        "category": TaskCategory.EXTERIOR,
        "priority": TaskPriority.MEDIUM,
        "interval_value": 2,
        "interval_unit": IntervalUnit.WEEKS,
    ...
    {
        "id": "pool_winterfest",
        "name": "Pool winterfest machen",
        "description": "Pool abdecken, Leitungen entleeren, Pumpe einlagern, Wintermittel zugeben",
        "category": TaskCategory.EXTERIOR,
        "priority": TaskPriority.HIGH,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
    ...
    {
        "id": "schornsteinfeger",
        "name": "Schornsteinfeger beauftragen",
        "description": "Schornstein kehren und Abgasmessung durch bevollmächtigten Bezirksschornsteinfeger durchführen lassen",
        "category": TaskCategory.HEATING,
        "priority": TaskPriority.CRITICAL,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
    ...
    # --- Weitere Geräte ---
    {
        ...
        "description": "Filter der Klimaanlage reinigen oder wechseln, Kondensatablauf prüfen, Kältemittel checken lassen",
        "category": TaskCategory.APPLIANCES,
        "priority": TaskPriority.HIGH,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
    ...
    {
        "id": "dach_kontrolle",
        "name": "Dach kontrollieren",
        "description": "Dachziegel auf Beschädigungen prüfen, Moos entfernen, Anschlüsse und Durchführungen kontrollieren",
        "category": TaskCategory.EXTERIOR,
        "priority": TaskPriority.HIGH,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
    ...
    {
        "id": "garagentor",
        "name": "Garagentor warten",
        "description": "Garagentor-Mechanik schmieren, Federn und Laufschienen prüfen, Sicherheitssensor testen",
        "category": TaskCategory.EXTERIOR,
        "priority": TaskPriority.MEDIUM,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
    ...
    {
        "id": "terrasse_reinigen",
        "name": "Terrasse und Einfahrt reinigen",
        "description": "Terrasse und Einfahrt mit Hochdruckreiniger reinigen, Fugen von Unkraut befreien",
        "category": TaskCategory.EXTERIOR,
        "priority": TaskPriority.LOW,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
    ...
    {
        "id": "photovoltaik",
        "name": "Photovoltaikanlage prüfen",
        "description": "Solarmodule auf Verschmutzung und Beschädigung prüfen, Ertragsdaten kontrollieren, Wechselrichter checken",
        "category": TaskCategory.ELECTRICAL,
        "priority": TaskPriority.MEDIUM,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
    ...
    {
        "id": "wasserenthaerter",
        "name": "Wasserenthärter warten",
        "description": "Salz nachfüllen, Regeneration prüfen, Wasserhärte messen",
        "category": TaskCategory.PLUMBING,
        "priority": TaskPriority.MEDIUM,
        "interval_value": 2,
        "interval_unit": IntervalUnit.MONTHS,
    },
    {
        ...
        "name": "Warmwasserspeicher entkalken",
        "description": "Warmwasserspeicher/Boiler entkalken und Magnesiumanode prüfen (alle 2-3 Jahre wechseln)",
        "category": TaskCategory.PLUMBING,
        "priority": TaskPriority.MEDIUM,
        "interval_value": 2,
        "interval_unit": IntervalUnit.YEARS,
    ...
    # --- Weitere Garten ---
    {
        "id": "garten_duengen",
        "name": "Rasen düngen",
        "description": "Rasen mit geeignetem Dünger versorgen (Frühjahr, Sommer, Herbst)",
        "category": TaskCategory.GARDEN,
        "priority": TaskPriority.LOW,
        "interval_value": 3,
        "interval_unit": IntervalUnit.MONTHS,
    ...
    {
        "id": "garten_baumschnitt",
        "name": "Obstbäume schneiden",
        "description": "Obstbäume im Spätwinter schneiden (Februar/März), Totholz entfernen, Krone auslichten",
        "category": TaskCategory.GARDEN,
        "priority": TaskPriority.MEDIUM,
        "interval_value": 1,
        "interval_unit": IntervalUnit.YEARS,
